import{u as p,Q as d,j as e,a6 as c,W as n,a7 as h,a8 as g,a9 as m,aa as x,a5 as b,i as u}from"./index-BloPbmfu.js";const f=b.find(s=>s.key==="C02"),t={en:{lead:"Research Assistant, Taiwan Mind and Brain Imaging Center — three responsibility clusters, and the same discipline running through every one of them: measure carefully, analyze honestly, and say what you found.",note:"Across two years the role scaled with the study — from running a single MRI session to building the pipeline a whole finding stood on."},zh:{lead:"台灣心智科學腦造影中心研究助理——三個職責叢集，貫穿其中的是同一套紀律：仔細量測、誠實分析，然後把發現說出來。",note:"兩年下來，這個角色隨著研究一起長大——從執行單一場 MRI 收案，到搭建起支撐一項發現的整條產線。"}};function j(){const{lang:s}=p(),r=d(),l=t[s]??t.en;return e.jsx(c,{chapter:f,lead:l.lead,note:l.note,children:e.jsx(n.div,{className:"bl-resp-grid",variants:x(.08),initial:r?!1:"hidden",whileInView:"show",viewport:{once:!0,amount:.1},children:h.map(i=>e.jsxs(n.div,{className:"bl-card bl-resp",variants:g,children:[e.jsxs("div",{className:"bl-resp-head",children:[e.jsx("span",{className:"bl-eyebrow",children:i.num}),e.jsx("h4",{className:"bl-resp-title",children:i.title[s]})]}),e.jsx("p",{className:"bl-resp-intro",children:i.intro[s]}),e.jsx("ul",{className:"bl-resp-duties",children:i.duties.map(a=>e.jsxs("li",{children:[e.jsx("strong",{children:a.title[s]}),e.jsx("span",{children:a.body[s]})]},a.key))}),e.jsx("div",{className:"bl-resp-tags",children:i.tags.map((a,o)=>e.jsx(m,{children:a[s]},o))})]},i.key))})})}u("bl-c02-styles",`
