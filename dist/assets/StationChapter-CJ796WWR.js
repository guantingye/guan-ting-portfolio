import{u as x,W as j,j as t,X as u,_ as y,Y as s,a6 as h,a7 as m,a8 as n,a9 as g,aa as v,ab as w,ac as b,ad as f,ae as k,af as z,ag as N,ah as F,ai as S,aj as C,Z as D,a0 as I,i as T}from"./index-Bv4593Va.js";const U={care:C,curriculum:S,aac:F,events:N,content:z,casedata:k,annual:n,project:f,podcast:b,web:w,form:v,lecture:g,data:n,strategy:m,crossorg:h},_=f;function B({duties:d,lang:a,reduced:r}){return t.jsx(s.ol,{className:"fj-duty-route",role:"list",variants:I(),initial:r?!1:"hidden",whileInView:"show",viewport:{once:!0,amount:.1},children:d.map((e,p)=>{const i=U[e.key]??_;return t.jsxs(s.li,{className:"fj-duty-step",variants:D,children:[t.jsx("span",{className:"fj-duty-marker","aria-hidden":"true",children:String(p+1).padStart(2,"0")}),t.jsxs("div",{className:"fj-duty-sheet",children:[t.jsxs("div",{className:"fj-duty-title-wrap",children:[t.jsx("span",{className:"fj-duty-icon","aria-hidden":"true",children:t.jsx(i,{})}),t.jsx("h4",{className:"fj-duty-title",children:e.title[a]})]}),t.jsx("div",{className:"fj-duty-copy",children:t.jsx("p",{className:"fj-duty-body",children:e.body[a]})})]})]},e.key)})})}function M({chapter:d,station:a,spotlight:r,spotlightTitle:e,spotlightCaption:p}){const{lang:i}=x(),o=j();return t.jsxs(u,{chapter:d,station:a,lead:a.intro[i],note:a.fieldNote[i],children:[r&&t.jsxs("div",{className:"fj-spot",children:[t.jsxs("div",{className:"fj-spot-head",children:[t.jsx("span",{className:"fj-eyebrow",children:i==="zh"?"招牌一件":"Signature piece"}),e&&t.jsx("h4",{className:"fj-spot-title",children:e})]}),r,p&&t.jsx("p",{className:"fj-spot-cap",children:p})]}),t.jsx(B,{duties:a.duties,lang:i,reduced:o}),t.jsx("div",{className:"fj-station-tags",children:a.tags.map((c,l)=>t.jsx(y,{children:c[i]},l))})]})}T("fj-station-styles",`
/* spotlight */
