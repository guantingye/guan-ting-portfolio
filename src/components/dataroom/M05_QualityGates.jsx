...
const GATES = [
  { id: 'coverage', label: { en: 'Data coverage', zh: '資料範圍' }, verdict: 'pass',
  ...
  { id: 'traceability', label: { en: 'Source traceability', zh: '來源可追溯性' }, verdict: 'pass',
  ...
  { id: 'identity', label: { en: 'Company entity consistency', zh: '企業實體一致性' }, verdict: 'review',
  ...
  { id: 'freshness', label: { en: 'Freshness', zh: '更新度' }, verdict: 'review',
  ...
  { id: 'conflict', label: { en: 'Cross-source conflicts', zh: '跨來源衝突' }, verdict: 'blocked',
  ...
  { id: 'output', label: { en: 'Output completeness', zh: '輸出完整度' }, verdict: 'pass',
...
const COPY = {
  en: {
    title: 'Data Quality Review Console',
    lead: 'Six checks cover data coverage, source traceability, company entity consistency, freshness, cross-source conflicts, and output completeness. After running a check, users can review the result and send anomalous records to manual review.',
    soWhat: 'Conflicting data is not overwritten directly; it is retained, flagged, and sent for review. This lets researchers see what uncertainty remains in the data rather than only a seemingly complete result.',
    soWhatLabel: 'Design focus →',
    run: 'Run check', running: 'Running…', queueTitle: 'Review queue', queueEmpty: 'There are currently no items pending review. After running data quality checks, records requiring manual confirmation will appear here.',
    summary: (pass, review, blocked) => `${pass} pass, ${review} need review, ${blocked} blocked.`,
  },
  zh: {
    title: '資料品質檢核台',
    lead: '六項檢核涵蓋資料範圍、來源追溯、企業實體一致性、更新度、跨來源衝突與輸出完整度。執行檢核後，可以查看判定結果，並將異常紀錄送入人工審核。',
    soWhat: '衝突資料不會被直接覆寫，而會被保留、標記並送入審核。研究人員因此能知道資料仍存有哪些不確定性，而不是只看到一個看似完整的結果。',
    soWhatLabel: '設計重點 →',
    run: '執行檢核', running: '執行中…', queueTitle: '審核佇列', queueEmpty: '目前沒有待審項目。執行品質檢核後，需要人工確認的紀錄會顯示在這裡。',
