...
4. **Design tokens**: Neural Signal OS palette (bg `#060709`→`#1C2028`, teal `#35C2B0`, amber `#E8A33D`, red `#D96A5B`). Fonts already loaded globally: Newsreader (display), Inter (body), JetBrains Mono (data). Reuse via a `.ghx` token block.
