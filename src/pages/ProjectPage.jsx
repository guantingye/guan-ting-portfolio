                ...
                React.createElement('div', { className: 'proj-section reveal' },
                    ...
                    React.createElement('div', { className: 'proj-tech-grid' },
                        p.tech.map(item => React.createElement('div', { className: 'tech-item', key: item.label },
                            React.createElement('div', { className: 'tech-item-label' }, lang === 'zh' ? item.zhLabel ?? item.label : item.label),
                            React.createElement('div', { className: 'tech-item-val' }, lang === 'zh' ? item.zhVal ?? item.val : item.val),
                            (item.description || item.zhDescription) && React.createElement('div', { className: 'tech-item-desc' }, lang === 'zh' ? item.zhDescription ?? item.description : item.description))))),
