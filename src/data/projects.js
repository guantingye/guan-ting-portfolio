...
目前系統支援 230+ 家企業的持續追蹤、欄位溯源、儀表板輸出與策略分析。本案例在不揭露內部敏感資料的前提下，重構並呈現其中的核心流程與設計決策。`,
    ...
    },
    {
        ...
        category: 'AI Product Strategy · Pre-Launch Decision System', zhCategory: 'AI 產品策略 · 上市前決策系統',
        ...
        heroBrief: {
            context: 'AI teams need to align product needs, model capabilities, and market evidence before committing to development.',
            zhContext: 'AI 團隊需要在投入開發前，對齊產品需求、模型能力與市場證據。',
            problem: 'User needs, technical risks, and validation results are scattered across different documents, making it difficult for teams to determine which assumptions deserve priority investment.',
            zhProblem: '使用者需求、技術風險與驗證結果分散在不同文件中，團隊難以判斷哪些假設值得優先投入。',
            strategy: 'A shared workspace connects product opportunities, validation plans, success metrics, and launch criteria so different functions can make decisions from the same information.',
            zhStrategy: '以共用工作台串接產品機會、驗證計畫、成功指標與上市條件，讓不同職能依據同一套資訊做決策。',
            delivery: 'Completed product positioning, a validation roadmap, a metric tree, a risk register, and seven pre-launch review criteria.',
            zhDelivery: '完成產品定位、驗證路線圖、指標樹、風險清單與 7 項上市檢核條件。',
        },
        ...
        overviewSingle: "Before an AI product is developed and brought to market, teams often need to answer several questions at once: Do users truly need it? Can the model reliably complete the task? Is there sufficient data to support the product? And have the relevant risks been identified? This information is typically scattered across interview notes, technical tests, competitive research, and documents from different teams, making decisions easy to base on individual experience rather than a consistent framework. I designed AI Product Launch OS as a cross-functional pre-launch decision workspace where product, design, engineering, and go-to-market teams can jointly organize product opportunities, core assumptions, validation evidence, success metrics, and launch conditions. Through opportunity scanning, product positioning, validation roadmaps, a metric tree, risk registers, and learning loops, the system helps teams determine which problems merit investment, where AI should intervene, what the first release needs to prove, and which risks still need attention before entering the market.",
        zhOverviewSingle: "AI 產品在投入開發與推向市場之前，往往需要同時回答幾個問題：使用者是否真的需要它、模型能否穩定完成任務、資料是否足以支撐產品，以及相關風險是否已被辨識。這些資訊通常分散在訪談紀錄、技術測試、競品研究與不同團隊的文件中，使決策容易依賴個別經驗，而缺少一致的判斷依據。我將 AI Product Launch OS 設計成一套跨職能的上市前決策工作台，讓產品、設計、工程與 Go-to-Market 團隊能共同整理產品機會、核心假設、驗證證據、成功指標與上市條件。系統透過機會掃描、產品定位、驗證路線圖、指標樹、風險清單與學習迴圈，協助團隊判斷什麼問題值得投入、AI 應該介入哪個環節、第一版需要證明什麼，以及在進入市場前還有哪些風險需要處理。",
        ...
        caseHeroImage: 'data:image/svg+xml;utf8,' + encodeURIComponent(
            ...
            + '</svg>'),
        storyIntro: {
            kicker: 'PRE-LAUNCH DECISION DESK', zhKicker: '上市前決策台',
            title: 'Turn high-risk assumptions into testable decisions', zhTitle: '把高風險假設，拆成可以驗證的決策',
            lead: 'Bring user needs, model capabilities, data conditions, and launch risks into one decision process so the team can align on current evidence, decision thresholds, and next actions before committing to development and go-to-market.',
            zhLead: '將使用者需求、模型能力、資料條件與上市風險整理進同一套判斷流程，讓團隊在投入開發與市場推廣前，先對齊現有證據、決策門檻與下一步行動。',
            motif: 'pulse',
        },
        caseDeck: {
            eyebrow: 'Pre-launch decision framework',
            zhEyebrow: '上市決策框架',
            title: 'Turn AI product uncertainty into questions the team can assess together',
            zhTitle: '讓 AI 產品的不確定性，變成團隊可以共同判斷的問題',
            body: 'Concentrate the key questions before an AI product launches: whether user demand is real and urgent, the product scope is clear, the data and model are ready for release, and which risks still require human confirmation.',
            zhBody: '集中整理 AI 產品上市前的關鍵問題：使用者需求是否真實且急迫、產品範圍是否清楚、資料與模型是否具備上線條件，以及哪些風險仍需要人工確認。',
            kpis: [
        ...
        storyMoments: [
            { iconKey: 'target', title: 'The product bet', zhTitle: '產品定位判斷', body: 'Clarify the target users, core problem, product promise, and priority use case to determine whether this opportunity merits investment now.', zhBody: '釐清目標使用者、核心問題、產品承諾與優先使用情境，判斷這項機會是否值得現在投入。' },
            { iconKey: 'chart', title: 'The evidence wall', zhTitle: '驗證依據', body: 'Bring together user research, product metrics, model limitations, and risk assumptions so the team knows what has been proven and which questions still need validation.', zhBody: '整合使用者研究、產品指標、模型限制與風險假設，讓團隊清楚知道目前已經證明了什麼，以及哪些問題仍待驗證。' },
            { iconKey: 'trend', title: 'The launch rhythm', zhTitle: '上市路徑', body: 'Connect internal alignment, pilot validation, external communication, and adoption review into one rollout plan so the team can continuously refine the product and launch approach as new evidence arrives.', zhBody: '將內部對齊、試點驗證、對外溝通與採用回顧串成一套推進計畫，讓團隊能依據新證據持續修正產品與上市方式。' },
        ],
        ...
        pullQuote: 'The persuasive power of an AI product is not that it “uses AI,” but that it improves a key decision, reduces specific risks, and helps the team validate and correct course faster.',
        zhPullQuote: 'AI 產品的說服力，不在於「使用了 AI」，而在於它改善了哪個關鍵決策、降低了哪些風險，並讓團隊更快驗證與修正。',
        certWall: [
    ...
    },
    {
        ...
        tech: [
            { label: 'Content extraction | CRAWLER', zhLabel: '內容擷取｜CRAWLER', val: 'Playwright, Trafilatura, feedparser, httpx', zhVal: 'Playwright、Trafilatura、feedparser、httpx', description: 'Handles dynamic pages, static articles, RSS, and HTTP requests according to source type.', zhDescription: '依來源型態處理動態頁面、靜態文章、RSS 與 HTTP 請求。' },
            { label: 'AI processing | AI LAYER', zhLabel: 'AI 處理層｜AI LAYER', val: 'Gemini, GPT-4o (earlier version), Prompt Chaining', zhVal: 'Gemini、GPT-4o（前期版本）、Prompt Chaining', description: 'Runs relevance assessment, entity extraction, classification, and strategic summarisation in stages.', zhDescription: '分階段執行相關性判斷、實體擷取、分類與策略摘要。' },
            { label: 'Data pipeline | PIPELINE', zhLabel: '資料管線｜PIPELINE', val: 'Python asynchronous processing, staged tasks, and retry mechanisms', zhVal: 'Python 非同步處理、多階段任務與重試機制', description: 'Separates source extraction, cleaning, deduplication, AI processing, and publishing into traceable execution stages.', zhDescription: '將來源擷取、清理、去重、AI 處理與發布拆成可追蹤的執行階段。' },
            { label: 'Data output | OUTPUT', zhLabel: '資料輸出｜OUTPUT', val: 'Notion API, structured data fields, and Markdown reports', zhVal: 'Notion API、結構化資料欄位與 Markdown 報告', description: 'Supports everyday reading, condition-based filtering, and later research-data exports.', zhDescription: '同時支援日常閱讀、條件篩選與後續研究資料匯出。' },
            { label: 'Information sources | SOURCES', zhLabel: '資訊來源｜SOURCES', val: 'TechCrunch, MIT Technology Review, TechNews, INSIDE, TNW, and subscription sources', zhVal: 'TechCrunch、MIT Technology Review、TechNews、INSIDE、TNW 與訂閱來源', description: 'Covers international technology news, Taiwan industry content, and topic-specific information streams.', zhDescription: '涵蓋國際科技新聞、台灣產業內容與主題型資訊流。' },
            { label: 'Data quality | QUALITY', zhLabel: '資料品質｜QUALITY', val: 'Entity deduplication, relevance scoring, and date normalisation', zhVal: '實體去重、相關性評分與日期標準化', description: 'Reduces duplicate content and format differences so cross-source data can be compared and queried consistently.', zhDescription: '降低重複內容與格式差異，讓跨來源資料可以被一致比較與查詢。' },
        ],
        caseHeroImage: NEWS_HERO_IMAGE,
        storyIntro: {
            kicker: 'DAILY INTELLIGENCE PIPELINE', zhKicker: '每日情報管線',
            title: 'A traceable tech briefing every morning', zhTitle: '每天早上，一份可追溯的科技簡報',
            lead: 'Six core news sources and a set of domain feeds move through five stages to produce a dated bilingual briefing each day. Every claim can be traced back to the original reporting.',
            zhLead: '六個主要新聞來源與一組領域 RSS feed，經過五個階段，每天產出一份附日期的雙語簡報；每個主張都能追溯回原始報導。',
            motif: 'wave',
        },
        caseDeck: {
            eyebrow: 'Editorial workflow', zhEyebrow: '編輯流程',
            title: 'From global news to a daily briefing teams can trace',
            zhTitle: '把全球新聞整理成團隊可回查的每日簡報',
            body: 'I built this pipeline independently. It crawls six core news sources and domain feeds, extracts full text, assesses relevance, and publishes a bilingual briefing each day; every claim remains traceable to the original reporting.',
            zhBody: '我獨立建立這條管線，爬取六個主要新聞來源與領域 RSS feed、擷取全文、判斷相關性，並每天發布雙語簡報。每個主張都可回查原始報導。',
            kpis: [
        ...
        storyMoments: [
            { iconKey: 'activity', title: 'Manage the volume before the analysis', zhTitle: '先處理資訊量，再開始分析', body: 'A deep-tech team needs to track daily AI, semiconductor, and frontier-science updates, but cannot read every item. Before analysis begins, the volume and spread of sources have to be managed.', zhBody: '深科技團隊每天要追蹤 AI、半導體與前沿科學的更新，卻無法逐則讀完。分析開始前，得先處理資訊量與來源分散的問題。' },
            { iconKey: 'layers', title: 'Make the workflow inspectable', zhTitle: '把流程做成可檢查的管線', body: 'Crawl, extract, score, summarise, and publish are separate, retryable, and inspectable stages. When a run fails, the affected step can be located, rerun, and corrected instead of leaving a black box.', zhBody: '爬取、萃取、評分、摘要與發布各自獨立，可重試、可檢查。某一步出錯時，可以定位、重跑並修正受影響的步驟，而不是只看到一個失敗結果。' },
            { iconKey: 'zap', title: 'Lower per-run cost without losing the quality band', zhTitle: '以相近品質，降低每次成本', body: 'I moved summarisation from GPT-4o to Gemini. On the same test set, output stayed in the same quality band while per-run cost fell about 75%; the staged workflow made the swap possible without rewriting the pipeline.', zhBody: '我把摘要階段從 GPT-4o 改為 Gemini；同一測試集裡，品質落在相同區間，每次執行成本約降 75%。分段流程讓更換模型不必重寫整條管線。' },
        ],
        storyChapters: [
        ...
        pullQuote: 'The hard part was not calling a model. It was building a workflow that turns high-volume news into a dated briefing whose claims a team can trace back to their sources each morning.',
        zhPullQuote: '困難不在呼叫模型，而在於建立能整理大量新聞的流程，讓團隊每天早上收到附日期、可回查來源的簡報。',
        awards: [],
    },
    {
        ...
        outcomes: ['Decomposed pressure anomalies into an actionable interaction flow spanning detection, alerting, decision-making, confirmation, recovery, and control handoff', 'Used information hierarchy, alert timing, visual density, and immediate feedback to reduce operator cognitive load instead of adding visual elements that compete for attention', 'Translated design decisions into operable frontend prototypes with responsive layouts, keyboard interaction, component states, and inspectable interaction specifications', 'Used an interactive design-lab format to make cognitive load, alert recognition, error recovery, and control handoff tangible for hands-on review and discussion', 'Integrated UX research, HMI principles, frontend implementation, and validation evidence into one design process, so every interface decision can explain its source, trade-off, and validation method'],
        zhOutcomes: ['將壓力異常拆解為一套可操作的互動流程，涵蓋察覺、警示、判斷、確認、復原與控制權交接。', '透過資訊層級、警報時機、畫面密度與即時回饋，降低操作員的認知負荷，而不是用更多視覺元素製造注意力競爭。', '將設計判斷落實為可操作的前端原型，涵蓋響應式版面、鍵盤操作、元件狀態與可檢查的互動規格。', '以互動實驗室的形式呈現人因設計，讓認知負荷、警報辨識、錯誤復原與控制權交接不只停留在理論，而能被實際操作與討論。', '將 UX 研究、HMI 原則、前端實作與驗證證據整合成同一套設計流程，讓每個介面決策都能說明來源、取捨與驗證方式。'],
        tech: [
            { label: 'HUMAN FACTORS', zhLabel: '人因因素', val: 'Cognitive load, attention allocation, risk perception, error prevention, recovery behavior', zhVal: '認知負荷、注意力配置、風險知覺、錯誤預防與復原行為' },
            { label: 'UX SYSTEM', zhLabel: 'UX 系統', val: 'Scenario mapping, task flows, state models, interface hierarchy, information density', zhVal: '情境地圖、任務流程、狀態模型、介面層級與資訊密度' },
            { label: 'HMI PATTERNS', zhLabel: 'HMI 模式', val: 'Alert hierarchy, multimodal status cues, confirmation timing, control handoff, recovery paths', zhVal: '警報層級、多重狀態線索、確認時機、控制權交接與復原路徑' },
            { label: 'FRONTEND CRAFT', zhLabel: '前端實作', val: 'React state management, keyboard navigation, responsive layouts, accessible components, reduced-motion support', zhVal: 'React 狀態管理、鍵盤導覽、響應式版面、無障礙元件與減少動態支援' },
            { label: 'DESIGN EVIDENCE', zhLabel: '設計證據', val: 'Scenario boards, state diagrams, usability findings, decision records, interactive prototypes', zhVal: '情境板、狀態圖、易用性發現、決策紀錄與互動原型' },
            { label: 'FOUNDATION & TRAINING', zhLabel: '基礎與培訓', val: 'UX design, front-end development, AI product and systems training', zhVal: 'Google UX Design、Meta Front-End Development、IBM AI 與系統培訓' },
        ],
        ...
        storyIntro: {
            ...
            title: 'Design for the moment pressure peaks', zhTitle: '為壓力最高的那一刻設計',
            lead: 'When the interface demands more attention than a person has to spare, design must establish priorities first. These seven interface states help people see the next step and make sound decisions under pressure.',
            zhLead: '當介面要求的注意力超過使用者所能分配的餘裕，設計就必須先建立優先順序。這七種介面狀態，讓人能在壓力下看見下一步並做出正確判斷。',
            motif: 'grid',
        },
        caseDeck: {
            eyebrow: 'Interaction lab',
            zhEyebrow: '互動實驗室',
            title: 'A calm decision layer between people and systems',
            zhTitle: '在使用者與系統之間留下冷靜的判斷層',
            body: 'A scenario-led workspace for observing what users notice first, where they misinterpret the interface, and how it should respond before an error expands.',
            zhBody: '這個情境導向的工作區，用來觀察使用者先注意到什麼、在哪裡誤解，以及介面要如何在錯誤擴大前提供足夠的提示與回應。',
            kpis: [
                { label: 'Interface states', value: '7', zhLabel: '介面狀態' },
                { label: 'Scenario perspectives', value: '5', zhLabel: '情境觀察面向' },
                { label: 'Prototype iterations', value: '3', zhLabel: '原型迭代' },
            ],
            signals: ['Attention', 'Severity', 'Confirmation', 'Recovery', 'Handoff'],
            zhSignals: ['注意力', '嚴重性', '確認', '復原', '交接'],
        },
        storyMoments: [
            { iconKey: 'activity', title: 'The first glance under pressure', zhTitle: '壓力下的第一眼', body: 'Design begins when attention is scarce. The first task is not adding information, but deciding what the user most needs to see next.', zhBody: '設計從注意力不足的時刻開始。第一件事不是增加資訊，而是決定使用者下一眼最需要看見什麼。' },
            { iconKey: 'shield', title: 'Use evidence to set the warning rhythm', zhTitle: '以證據安排警示節奏', body: 'Warnings should not simply get louder; their level should change with risk and evidence. The system moves through signal, explanation, confirmation, and recovery so people can understand before acting.', zhBody: '警示不該只提高音量，而要隨風險與證據改變層級。系統依序提供提示、說明、確認與復原，讓人能理解後再行動。' },
            { iconKey: 'monitor', title: 'Let frontend behaviour carry the design', zhTitle: '把設計落在前端行為上', body: 'Focus order, unavailable states, responsive density, and component responses under pressure determine whether the design stays clear in real use.', zhBody: '焦點順序、不可用狀態、響應式密度與元件在壓力下的回應，決定設計是否能在真實操作中維持清楚。' },
        ],
        storyChapters: [
        ...
        pullQuote: 'Good HMI does not ask people to think harder under pressure. It makes the system’s next action easier to see and understand.',
        zhPullQuote: '好的 HMI 不要求使用者在壓力下更努力思考；它把系統的下一步行動安排得更容易被看見與理解。',
        certWall: [
    ...
    },
    {
        ...
        outcomes: [
            'Designed and shipped a live bilingual product with three public surfaces: a globe-led home, a strategic-briefs reader, and a searchable observatory of 201 companies',
            'Established a ten-field schema that keeps company records comparable across sectors while preserving analyst context beyond basic company data',
            'Defined the six-section research method used for both strategic briefs and company notes, from coding agents to gene-editing platforms',
            'Designed, but did not ship, an AI strategist layer: eight checkable skills, an editorial workflow, and a grounded RAG query layer',
            'Implemented the interaction system across the three routes: globe hub switching, expandable rows, sector filtering, and bilingual switching',
        ],
        zhOutcomes: [
            '設計並上線一個雙語產品，包含地球儀導向首頁、策略簡報閱讀器，以及可搜尋的 201 家公司觀測站',
            '建立十欄位 schema，讓不同產業的公司紀錄能被比較，同時保留超出基本資料的分析師脈絡',
            '定義策略簡報與公司註記共用的六段研究方法，從編碼代理到基因編輯平台皆使用同一套架構',
            '設計但尚未上線 AI 策略師層：八個可檢查技能、文案管理流程，以及依據式 RAG 查詢層',
            '實作三條路徑共用的互動系統：地球儀 hub 切換、原位展開列、產業篩選與雙語切換',
        ],
        tech: [
            { label: 'Frontend', zhLabel: '前端', val: 'React, client-side routing, a bilingual English / Traditional Chinese interface, and Vercel deployment.', zhVal: 'React、client-side routing、繁中／英文雙語介面與 Vercel 部署。' },
            { label: 'Data model', zhLabel: '資料模型', val: '201 curated company records with a ten-field schema and six analyst-written research sections.', zhVal: '201 筆策展公司紀錄，採用十欄位 schema 與六段分析師研究註記。' },
            { label: 'Writing method', zhLabel: '寫作方法', val: 'Analyst-authored strategic briefs and company notes, dated by curation batch and ending in a stated research judgment.', zhVal: '由分析師撰寫策略簡報與公司註記，依策展批次標記日期，並保留明確的研究判斷。' },
            { label: 'AI strategist design', zhLabel: 'AI 策略師設計', val: 'An eight-skill drafting workflow with evidence and confidence gates. Concept design; not connected to the live product.', zhVal: '由八項技能組成的草稿工作流，含證據與信心閘門；為概念設計，尚未接入線上產品。' },
            { label: 'Editorial workflow design', zhLabel: '文案管理流程設計', val: 'A six-state editorial workflow from backlog through publication and stale review. Concept design.', zhVal: '從待辦到發布與過期檢視的六狀態文案管理流程；為概念設計。' },
            { label: 'Grounded RAG design', zhLabel: '依據式 RAG 設計', val: 'Typed chunks, hybrid structured and semantic retrieval, citations, and explicit refusal. Concept design.', zhVal: '具型別切塊、結構化與語意混合檢索、引用與明確拒答；為概念設計。' },
        ],
        caseHeroImage: ISP_HERO_IMAGE,
        storyIntro: {
            kicker: 'STRATEGY OBSERVATORY', zhKicker: '策略觀測站',
            title: '201 companies, a traceable judgment in every row', zhTitle: '201 家公司，每列一個可追溯的判斷',
            lead: 'I built this frontier-tech database to record more than company facts. A fixed schema captures analyst assessments of moat, business model, funding, risk, and verdict. The AI strategist remains a concept: it explores how that depth could scale while staying constrained by the existing schema and sources.',
            zhLead: '我建立這個前沿科技資料庫，不只記錄公司基本資料，也以固定欄位整理分析師對護城河、商業模式、資金、風險與判斷的觀察。AI 策略師仍是概念設計；它探索如何在既有 schema 與來源約束下，延續這種判讀深度。',
            motif: 'orbit',
        },
        caseDeck: {
            eyebrow: 'Strategy observatory', zhEyebrow: '策略觀測站',
            title: 'A strategy database built for comparison',
            zhTitle: '把 201 筆公司紀錄做成可比較的策略資料庫',
            body: 'A consistent ten-field schema and six analyst-written sections make moat, business model, funding, risk, and verdict comparable across frontier-tech companies. The AI layer is a not-yet-shipped concept for extending that work without losing traceability.',
            zhBody: '我以一致的十欄位和六段分析師判讀，整理前沿科技公司的護城河、商業模式、資金、風險與結論。AI 層則是尚未上線的概念設計，用來探索如何在不犧牲可追溯性的前提下延續這套判讀。',
            kpis: [
        ...
        storyMoments: [
            { iconKey: 'database', title: 'The database is an analysis surface', zhTitle: '資料庫不是名單，而是分析介面', body: 'All 201 companies use the same ten-field record, with six analyst-written sections. The shared structure makes very different sectors comparable and lets each conclusion be traced back to its basis.', zhBody: '201 家公司都使用同一套十欄位紀錄，其中六段由分析師撰寫。固定結構讓不同領域的公司能被比較，也讓每筆結論能回到判讀依據。' },
            { iconKey: 'cpu', title: 'An AI strategist: concept, not live feature', zhTitle: 'AI 策略師：概念，不是已上線功能', body: 'The eight checkable skills, editorial-operations board, and RAG query layer are not connected to the product. The design explores how AI can work within the existing schema and evidence constraints, including when it should hold or refuse an answer.', zhBody: '八項可檢查技能、文案管理看板與 RAG 查詢層都尚未接上產品。設計重點在於讓 AI 以既有 schema 與證據約束工作，資料不足時保留或拒答。' },
            { iconKey: 'globe', title: 'Make the global scope legible first', zhTitle: '先讓全球範圍可讀，再談深入比較', body: 'The globe gives readers an immediate view of geographic coverage. Deeper comparison then returns to the same structured fields and analyst notes behind every company record.', zhBody: '首頁以地球儀呈現跨地理分布，幫讀者先掌握觀測範圍；深入判讀則回到同一套資料欄位與分析師註記。' },
        ],
        outcomeModules: [
            { num: '02', id: 'isp-m02' },
            { num: '04', id: 'isp-m04' },
        ...
        pullQuote: 'Crunchbase tells you that a company exists. This platform uses a consistent structure to explain why it is—or is not—worth tracking. The AI layer matters only if it can preserve the sources and reasoning behind that judgment.',
        zhPullQuote: 'Crunchbase 告訴你一家公司存在；這個平台的工作，是用一致結構說明它為何值得、或不值得持續追蹤。AI 層只有在能保留來源與判讀依據時，才有擴張的意義。',
        awards: [],
    },
    {
